...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es">
    ...
    if(isset($_GET['elim'])) {
        ...
        // Validar que 'elim' solo pueda ser 0 o 1
        if ($elim !== '0' && $elim !== '1') {
            die('<p class="alert alert-danger">Error: El parámetro "elim" solo puede ser 0 o 1.</p>');
        }
        $elim = intval($elim); // Convertimos a número entero seguro
    } else {
        die('<p class="alert alert-danger">Parámetro "elim" no detectado...</p>');
    }

    if ($elim === 0) { // Solo mostrar productos NO eliminados
        ...
        /** Obtener los productos con eliminado = 0 */
        $productos = [];
    ...
    <script>
        ...
        <?php else: ?>
            <p class="alert alert-warning">No hay productos disponibles.</p>
        <?php endif; ?>
    </body>
</html>
