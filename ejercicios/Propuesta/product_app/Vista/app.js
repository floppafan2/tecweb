...
$(document).ready(function(){
    ...
    $('#search').keyup(function(e) {
        if($('#search').val()){
            ...
            $.ajax({
                url: '../Controlador/product-search.php?search='+search,
                type: 'GET',
...
function fetchProducts() {
    $.ajax({
        url: '../Controlador/product-list.php',
        type: 'GET',
        dataType: 'json', // Asegura que jQuery parseé la respuesta como JSON
        success: function(response) {
...
error: function(xhr, status, error) {
    ...
    $(document).on('click','.product-delete',function(){
        if(confirm('Quieres eliminarlo?')){
            ...
            $.get('../Controlador/product-delete.php',{id:id},function(response){
                fetchProducts();
            })
        }
    })
    ...
    $(document).on('click', '.product-item', function () { 
        ...
        $.post('../Controlador/product-get.php', { id }, function (response) {
            edit = true;
